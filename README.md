...
test `.jshintrc`, it will now be available in all of your tests. _Note: Older versions of ember-feature-flags do not include this import: `import 'ember-feature-flags/test-support/helpers/with-feature';`. Try using `withFeature` without the import if you experience problems._
